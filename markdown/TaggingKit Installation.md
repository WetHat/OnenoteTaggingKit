...
2. Make sure _OneNote_is **not running**! Exit _OneNote_if necessary.
3. Run the installer downloaded from the
   [Releases](https://github.com/WetHat/OnenoteTaggingKit/releases) page.

   Alternatively you can also install or upgrade the _OneNote Tagging Kit_ via the [Chocolatey](https://chocolatey.org/)
