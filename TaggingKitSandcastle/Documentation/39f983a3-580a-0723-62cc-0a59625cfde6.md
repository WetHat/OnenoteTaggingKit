# NewPresetModel.SelectedTags Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

Get/set an overvable list of view models for the tags in the preset.
...
**C#**<br />
``` C#
public ObservableTagList<SelectedTagModel> SelectedTags { get; set; }
```
