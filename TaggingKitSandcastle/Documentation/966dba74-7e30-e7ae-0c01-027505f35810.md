...
public class HitHighlightedPageLink : UserControl, 
	IComponentConnector
```

The HitHighlightedPageLink type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="096bbb3f-fefa-a382-e8b3-d85937c4704e.md">HitHighlightedPageLink</a></td><td>
Create a new instance of an hit highligted item in a page search result,</td></tr></table>&nbsp;
<a href="#hithighlightedpagelink-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="2d98d999-f945-63f0-3c6a-ac0bec9286e6.md">InitializeComponent</a></td><td>
...
Event fired for clicks on links to OneNote pages.</td></tr><tr><td>![Public event](media/pubevent.gif "Public event")</td><td>ContextMenuClosing</td><td>
...
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Explicit interface implementation](media/pubinterface.gif "Explicit interface implementation")![Private method](media/privmethod.gif "Private method")</td><td><a href="8fb19606-0eb5-c456-724e-7d09aae1bd98.md">IComponentConnector.Connect</a></td><td /></tr><tr><td>![Explicit interface implementation](media/pubinterface.gif "Explicit interface implementation")![Private method](media/privmethod.gif "Private method")</td><td>IAddChild.AddChild</td><td>
