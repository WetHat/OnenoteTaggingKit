...
| abstract class [RefinementTagBase](./WetHatLab.OneNote.TaggingKit.find/RefinementTagBase.md) | Aa abstract decorator base class for OneNote page tags used to filter sets of OneNote pages based on specific rules implemented by subclasses. |
