...
namespace WetHatLab.OneNote.TaggingKit.find
{
    ...
    public class FindTaggedPagesDesignerModel : IFindTaggedPagesModel
    {
        ...
        private RefinementTagModelSource _tags;
        ...
        public FindTaggedPagesDesignerModel() {
            ...
            _tags = new RefinementTagModelSource(_filteredPages);
        ...
        /// </summary>
        public RefinementTagModelSource WithAllRefimenetTagSource => _tags;
