...
namespace WetHatLab.OneNote.TaggingKit.find
{
    ...
    public class FindTaggedPagesDesignerModel : IFindTaggedPagesModel
    {
        ...
        private FilteredPages _filteredPages = new FilteredPages(null);
        ...
        public FindTaggedPagesDesignerModel() {
            ...
            _pageModels.AddAll(from TaggedPage tp in c.Pages.Values select new HitHighlightedPageLinkModel(tp, splitter, null));
